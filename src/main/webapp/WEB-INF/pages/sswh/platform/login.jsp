...
<head>
    ...
    <title>登录界面</title>
    <link href="${path}/resources/css/login/default.css" rel="stylesheet" type="text/css" />
    <!--必要样式-->
    <link href="${path}/resources/css/login/styles.css" rel="stylesheet" type="text/css" />
    <link href="${path}/resources/css/login/demo.css" rel="stylesheet" type="text/css" />
    <link href="${path}/resources/css/login/loaders.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div class='login'>
    ...
    <div class='login_fields'>
        <div class='login_fields__user'>
            <div class='icon'>
                <img alt="" src='${path}/resources/img/user_icon_copy.png'>
            </div>
            <input name="login" placeholder='用户名' maxlength="16" type='text' autocomplete="off" value="123456"/>
            <div class='validation'>
                <img alt="" src='${path}/resources/img/tick.png'>
            </div>
        </div>
        <div class='login_fields__password'>
            <div class='icon'>
                <img alt="" src='${path}/resources/img/lock_icon_copy.png'>
            </div>
...
<script type="text/javascript" src="${path}/resources/scripts/Particleground.js"></script>
<script type="text/javascript" src="${path}/resources/scripts/Treatment.js"></script>
<script type="text/javascript" src="${path}/resources/scripts/jquery.mockjax.js"></script>
