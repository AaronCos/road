                ...
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space5">
                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" name="title" placeholder="请输入机构名称" autocomplete="on"
                                   class="layui-input">
                        </div>
                        <div class="layui-inline layui-show-xs-block">
    ...
    layui.use(['laydate', 'form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'puuid', title: '父机构名称', align: 'center'},
                {field: 'spec', title: '机构说明', align: 'center'},
                {field: 'codeid', title: '机构标识', align: 'center'},
        ...
        table.on('tool(lay-filter-table)', function (obj) {
            ...
            if (obj.event === 'edit') {
                layer.open({
                    ...
                    content: ["${path}/group/showedit.do?iid=" + data.iid, "yes"],
        ...
        form.on('switch(lay-filter-show)', function(obj){
            ...
            $.ajax({
                url :  "${path}/group/changepageshow.do",
                type : "POST",
                datatype : "json",
                async : true,
                data : {
