    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-body ">
                    <%--../../resources/center/user.json--%>
                    <table class="layui-table"
                           lay-data="{url:'../data/members.do',page:true,toolbar: '#toolbarDemo',id:'test'}" lay-filter="test">
                        <thead>
                        <tr>
                            <th lay-data="{type:'checkbox'}">ID</th>
                            <th lay-data="{field:'iid', width:80, sort: true}">ID</th>
                            ...
                            <th lay-data="{field:'dw_xinzhi',templet: function(d){ return d.dw_xinzhi.title;}}  ">学校</th>
                        </tr>
                        </thead>
                    </table>
                </div>
