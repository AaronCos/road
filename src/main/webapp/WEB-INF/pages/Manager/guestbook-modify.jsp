	...
	<body>
		...
		<div id="main" class="wrap">
			...
			<div class="main">
				...
				<div class="manage">
					<form
						action="DoBackCommentUpdate?commentId=${requestScope.comment.c_id }"
						...
						<table class="form">
							<tr>
								...
								<td>
									<input type="text" class="text" name="orderId"
										value="${requestScope.comment.c_id }" readonly="readonly" />
								</td>
							</tr>
							<tr>
								<td class="field">
								...
								<td>
									<input type="text" class="text" name="name"
										value="${requestScope.comment.c_nick_name }"
										readonly="readonly" />
								</td>
							</tr>
							<tr>
								...
								<td>
									<input type="text" class="text" name="name"
										value="${requestScope.comment.c_content }" readonly="readonly" />
								</td>
							</tr>
							<tr>
								<td class="field">
