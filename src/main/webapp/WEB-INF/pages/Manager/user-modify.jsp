...
function check() {
	...
	if (document.getElementById("userName").value == "") {
		...
		alert("出生日期格式不正确！例如:1991-1-1");
		return false;
	} else if (reg2.test(document.getElementById("mobile").value) == false) {
		alert("手机号码格式不正确！");
		return false;
	}
	return true;
	...
	<body>
		...
		<div id="main" class="wrap">
			...
			<div class="main">
				...
				<div class="manage">
					<form action="DoBackUserUpdate" method="post"
						...
						<table class="form">
							<tr>
								...
								<td>
									<input type="text" class="text" name="userName" id="userName"
										value="${sessionScope.userlist.u_id }" readonly="readonly" />
								</td>
							</tr>
							<tr>
								<td class="field">
								...
								<td>
									<input type="text" class="text" name="name" id="name"
										value="${sessionScope.userlist.u_name }" />
								</td>
							</tr>
							<tr>
								<td class="field">
								...
								<td>
									<input type="password" class="text" name="passWord"
										id="passWord" value="${sessionScope.userlist.u_password }" />
								</td>
							</tr>
							<tr>
								<td class="field">
								...
								<f:if test="${sessionScope.userlist.u_sex eq '男'}">
									<td>
								...
								<f:if test="${sessionScope.userlist.u_sex eq '女'}">
									<td>
								...
								<f:if test="${sessionScope.userlist.u_sex == null}">
									<td>
										<input type="radio" name="sex" value="男" checked="checked" />
										男
										<input type="radio" name="sex" value="女" />
							...
							<tr>
								...
								<td>
									<input name="begindatetime" type="text" class="text"
										value="${sessionScope.userlist.u_birthday }"
							...
							<tr>
								...
								<td>
									<input type="text" class="text" name="mobile" id="mobile"
										value="${sessionScope.userlist.u_mobile }" />
								</td>
							</tr>
							<tr>
								<td class="field">
								...
								<td>
									<input type="text" class="text" name="address" id="address"
										value="${sessionScope.userlist.u_address }" />
								</td>
							</tr>
							<tr>
								<td></td>
