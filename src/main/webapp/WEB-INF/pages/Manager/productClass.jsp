					...
					<table class="list">
						...
						<f:forEach var="cotefory" items="${P_Categorys}">
							...
							<tr>
								...
								<td class="w1 c">
									<a href="DoProductClassBackModifySelect?id=${cotefory.c_id}">修改</a>
									<a
										href="DoProductClassBackDelete?id=${cotefory.c_id}&pid=${cotefory.c_parent_id}">删除</a>
								</td>
							</tr>
							<f:forEach var="shop" items="${categorys}">
								<f:if test="${shop.c_parent_id ==cotefory.c_id }">
									<tr>
										...
										<td class="w1 c">
											<a href="DoProductClassBackModifySelect?id=${shop.c_id}">修改</a>
											<a
												href="DoProductClassBackDelete?id=${shop.c_id}&pid=${shop.c_parent_id}">删除</a>
										</td>
									</tr>
