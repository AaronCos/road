	...
	<body>
		...
		<div id="main" class="wrap">
			...
			<div class="main">
				...
				<div class="manage">
					<form action="DoProductBackUpdate?id=${id}"
							...
							<tr>
								...
								<td>
									<input id="p_brand" type="text" class="text"
										name="productbrand" value="${product.name}" />
								</td>
							</tr>
							<tr>
								<td class="field">
								...
								<td>
									<input id="p_count" type="text" class="text tiny"
										name="productCount" value="${product.stock}" />
								</td>
							</tr>
							<tr>
								<td class="field">
								...
								<td>
									<input id="p_number" type="text" class="text"
										name="productnumber" value="${product.categoryId}" />
								</td>
							</tr>
							<tr>
								<td></td>
